...
Generated on: 2026-01-24T17:25:05.710Z
...
### 📁 `gemini-client.test.ts` <small>(Unit/Mapped)</small>
...
> 📄 **Snippet:** `// start snippet should-be-defined` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-be-defined"}
```
...
> 📄 **Snippet:** `// start snippet should-navigate-to-the-base-url-if-no-session-id-i` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-navigate-to-the-base-url-if-no-session-id-i"}
```
...
> 📄 **Snippet:** `// start snippet should-navigate-to-the-specific-session-url-if-an-` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-navigate-to-the-specific-session-url-if-an-"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-and-click-cookie-consent-button` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-handle-and-click-cookie-consent-button"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-and-click-dismiss-buttons-for-popups` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-handle-and-click-dismiss-buttons-for-popups"}
```
...
> 📄 **Snippet:** `// start snippet should-throw-an-error-if-a-sign-in-button-is-detec` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-throw-an-error-if-a-sign-in-button-is-detec"}
```
...
> 📄 **Snippet:** `// start snippet should-wait-for-the-chat-interface-to-be-ready` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-wait-for-the-chat-interface-to-be-ready"}
```
...
> 📄 **Snippet:** `// start snippet should-throw-an-error-if-chat-interface-is-not-fou` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-throw-an-error-if-chat-interface-is-not-fou"}
```
...
> 📄 **Snippet:** `// start snippet should-fill-the-input-press-enter-and-wait-for-a-r` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-fill-the-input-press-enter-and-wait-for-a-r"}
```
...
> 📄 **Snippet:** `// start snippet should-return-null-if-waitforresponse-is-false` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-return-null-if-waitforresponse-is-false"}
```
...
> 📄 **Snippet:** `// start snippet should-return-null-and-log-an-error-if-sending-fai` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-return-null-and-log-an-error-if-sending-fai"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-response-stabilization` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="should-handle-response-stabilization"}
```
...
> 📄 **Snippet:** `// start snippet getresponses-should-return-an-array-of-all-respons` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="getresponses-should-return-an-array-of-all-respons"}
```
...
> 📄 **Snippet:** `// start snippet getlatestresponse-should-return-the-text-of-the-la` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="getlatestresponse-should-return-the-text-of-the-la"}
```
...
> 📄 **Snippet:** `// start snippet getlatestresponse-should-return-null-if-no-respons` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="getlatestresponse-should-return-null-if-no-respons"}
```
...
> 📄 **Snippet:** `// start snippet getresponse-should-retrieve-responses-by-positive-` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="getresponse-should-retrieve-responses-by-positive-"}
```
...
> 📄 **Snippet:** `// start snippet listsessions-should-return-an-empty-array-on-failu` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="listsessions-should-return-an-empty-array-on-failu"}
```
...
> 📄 **Snippet:** `// start snippet getlatestresponse-should-return-null-on-failure` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="getlatestresponse-should-return-null-on-failure"}
```
...
> 📄 **Snippet:** `// start snippet exporttogoogledocs-should-return-null-values-on-fa` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="exporttogoogledocs-should-return-null-values-on-fa"}
```
...
> 📄 **Snippet:** `// start snippet listsessions-should-scroll-to-load-more-sessions-i` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="listsessions-should-scroll-to-load-more-sessions-i"}
```
...
> 📄 **Snippet:** `// start snippet listsessions-should-click-show-more-button-if-visi` in [`tests/gemini-client.test.ts`](tests/gemini-client.test.ts)

```{.typescript include="tests/gemini-client.test.ts" snippet="listsessions-should-click-show-more-button-if-visi"}
```
...
### 📁 `e2e/gemini.test.ts` <small>(Unit/Mapped)</small>
...
> 📄 **Snippet:** `// start snippet should-navigate-to-gemini-and-verify-login-status` in [`tests/e2e/gemini.test.ts`](tests/e2e/gemini.test.ts)

```{.typescript include="tests/e2e/gemini.test.ts" snippet="should-navigate-to-gemini-and-verify-login-status"}
```
...
> 📄 **Snippet:** `// start snippet should-parse-an-existing-research-session` in [`tests/e2e/gemini.test.ts`](tests/e2e/gemini.test.ts)

```{.typescript include="tests/e2e/gemini.test.ts" snippet="should-parse-an-existing-research-session"}
```
...
### 📁 `selectors.test.ts` <small>(Unit/Mapped)</small>
...
> 📄 **Snippet:** `// start snippet should-return-default-selectors-when-selectors-yam` in [`tests/selectors.test.ts`](tests/selectors.test.ts)

```{.typescript include="tests/selectors.test.ts" snippet="should-return-default-selectors-when-selectors-yam"}
```
...
> 📄 **Snippet:** `// start snippet should-load-and-merge-selectors-from-selectors-yam` in [`tests/selectors.test.ts`](tests/selectors.test.ts)

```{.typescript include="tests/selectors.test.ts" snippet="should-load-and-merge-selectors-from-selectors-yam"}
```
...
> 📄 **Snippet:** `// start snippet should-fall-back-to-defaults-when-loading-fails-e-` in [`tests/selectors.test.ts`](tests/selectors.test.ts)

```{.typescript include="tests/selectors.test.ts" snippet="should-fall-back-to-defaults-when-loading-fails-e-"}
```
...
> 📄 **Snippet:** `// start snippet should-force-reload-of-selectors-and-invalidate-ca` in [`tests/selectors.test.ts`](tests/selectors.test.ts)

```{.typescript include="tests/selectors.test.ts" snippet="should-force-reload-of-selectors-and-invalidate-ca"}
```
...
> 📄 **Snippet:** `// start snippet should-trigger-loadselectors-when-accessing-a-prop` in [`tests/selectors.test.ts`](tests/selectors.test.ts)

```{.typescript include="tests/selectors.test.ts" snippet="should-trigger-loadselectors-when-accessing-a-prop"}
```
...
### 📁 `graph.test.ts` <small>(Unit/Mapped)</small>
...
> 📄 **Snippet:** `// start snippet should-be-tested-in-graph-store-test-ts` in [`tests/graph.test.ts`](tests/graph.test.ts)

```{.typescript include="tests/graph.test.ts" snippet="should-be-tested-in-graph-store-test-ts"}
```
...
### 📁 `artifact-registry.test.ts` <small>(Unit/Mapped)</small>
...
> 📄 **Snippet:** `// start snippet should-generate-unique-3-character-base-ids` in [`tests/artifact-registry.test.ts`](tests/artifact-registry.test.ts)

```{.typescript include="tests/artifact-registry.test.ts" snippet="should-generate-unique-3-character-base-ids"}
```
...
> 📄 **Snippet:** `// start snippet should-register-and-retrieve-a-session` in [`tests/artifact-registry.test.ts`](tests/artifact-registry.test.ts)

```{.typescript include="tests/artifact-registry.test.ts" snippet="should-register-and-retrieve-a-session"}
```
...
> 📄 **Snippet:** `// start snippet should-register-and-retrieve-a-document` in [`tests/artifact-registry.test.ts`](tests/artifact-registry.test.ts)

```{.typescript include="tests/artifact-registry.test.ts" snippet="should-register-and-retrieve-a-document"}
```
...
> 📄 **Snippet:** `// start snippet should-register-and-retrieve-audio-with-incrementi` in [`tests/artifact-registry.test.ts`](tests/artifact-registry.test.ts)

```{.typescript include="tests/artifact-registry.test.ts" snippet="should-register-and-retrieve-audio-with-incrementi"}
```
...
> 📄 **Snippet:** `// start snippet should-track-lineage-correctly` in [`tests/artifact-registry.test.ts`](tests/artifact-registry.test.ts)

```{.typescript include="tests/artifact-registry.test.ts" snippet="should-track-lineage-correctly"}
```
...
> 📄 **Snippet:** `// start snippet should-persist-data-to-disk` in [`tests/artifact-registry.test.ts`](tests/artifact-registry.test.ts)

```{.typescript include="tests/artifact-registry.test.ts" snippet="should-persist-data-to-disk"}
```
...
> 📄 **Snippet:** `// start snippet should-list-artifacts-by-type` in [`tests/artifact-registry.test.ts`](tests/artifact-registry.test.ts)

```{.typescript include="tests/artifact-registry.test.ts" snippet="should-list-artifacts-by-type"}
```
...
### 📁 `windmill.test.ts` <small>(Unit/Mapped)</small>
...
> 📄 **Snippet:** `// start snippet should-trigger-audio-generation-and-update-graph-s` in [`tests/windmill.test.ts`](tests/windmill.test.ts)

```{.typescript include="tests/windmill.test.ts" snippet="should-trigger-audio-generation-and-update-graph-s"}
```
...
> 📄 **Snippet:** `// start snippet should-match-a-completed-audio-file-and-update-the` in [`tests/windmill.test.ts`](tests/windmill.test.ts)

```{.typescript include="tests/windmill.test.ts" snippet="should-match-a-completed-audio-file-and-update-the"}
```
...
> 📄 **Snippet:** `// start snippet should-query-the-rsrch-server-and-return-sources` in [`tests/windmill.test.ts`](tests/windmill.test.ts)

```{.typescript include="tests/windmill.test.ts" snippet="should-query-the-rsrch-server-and-return-sources"}
```
...
> 📄 **Snippet:** `// start snippet should-send-a-success-notification-to-ntfy` in [`tests/windmill.test.ts`](tests/windmill.test.ts)

```{.typescript include="tests/windmill.test.ts" snippet="should-send-a-success-notification-to-ntfy"}
```
...
### 📁 `adversarial.test.ts` <small>(Integration/Orphan)</small>
...
> 📄 **Snippet:** `// start snippet should-handle-empty-messages-array-gracefully` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-handle-empty-messages-array-gracefully"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-messages-with-empty-content` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-reject-messages-with-empty-content"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-only-system-message` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-handle-only-system-message"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-pollintervalms-0-edge-case` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-handle-pollintervalms-0-edge-case"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-timeoutms-0-edge-case` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-handle-timeoutms-0-edge-case"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-options-preflight-correctly` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-handle-options-preflight-correctly"}
```
...
> 📄 **Snippet:** `// start snippet should-allow-authorization-header-via-cors` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-allow-authorization-header-via-cors"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-non-string-message-content` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-reject-non-string-message-content"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-invalid-message-role` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-reject-invalid-message-role"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-messages-missing-required-fields` in [`tests/adversarial.test.ts`](tests/adversarial.test.ts)

```{.typescript include="tests/adversarial.test.ts" snippet="should-reject-messages-missing-required-fields"}
```
...
### 📁 `auth-sanity.test.ts` <small>(Integration/Orphan)</small>
...
> 📄 **Snippet:** `// start snippet should-be-able-to-get-a-response-from-gemini-confi` in [`tests/auth-sanity.test.ts`](tests/auth-sanity.test.ts)

```{.typescript include="tests/auth-sanity.test.ts" snippet="should-be-able-to-get-a-response-from-gemini-confi"}
```
...
> 📄 **Snippet:** `// start snippet should-be-able-to-get-a-response-from-perplexity-c` in [`tests/auth-sanity.test.ts`](tests/auth-sanity.test.ts)

```{.typescript include="tests/auth-sanity.test.ts" snippet="should-be-able-to-get-a-response-from-perplexity-c"}
```
...
### 📁 `export.test.ts` <small>(Integration/Orphan)</small>
...
> 📄 **Snippet:** `// start snippet should-correctly-extract-research-data-from-dom-el` in [`tests/export.test.ts`](tests/export.test.ts)

```{.typescript include="tests/export.test.ts" snippet="should-correctly-extract-research-data-from-dom-el"}
```
...
> 📄 **Snippet:** `// start snippet should-generate-valid-markdown-from-parsed-structu` in [`tests/export.test.ts`](tests/export.test.ts)

```{.typescript include="tests/export.test.ts" snippet="should-generate-valid-markdown-from-parsed-structu"}
```
...
> 📄 **Snippet:** `// start snippet should-correctly-extract-different-research-data-t` in [`tests/export.test.ts`](tests/export.test.ts)

```{.typescript include="tests/export.test.ts" snippet="should-correctly-extract-different-research-data-t"}
```
...
> 📄 **Snippet:** `// start snippet should-format-full-research-document-correctly` in [`tests/export.test.ts`](tests/export.test.ts)

```{.typescript include="tests/export.test.ts" snippet="should-format-full-research-document-correctly"}
```
...
### 📁 `gemini-client.unit.test.ts` <small>(Integration/Orphan)</small>
...
> 📄 **Snippet:** `// start snippet should-convert-code-blocks-with-language` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-code-blocks-with-language"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-code-blocks-without-language` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-code-blocks-without-language"}
```
...
> 📄 **Snippet:** `// start snippet should-decode-html-entities-in-code-blocks` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-decode-html-entities-in-code-blocks"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-inline-code` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-handle-inline-code"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-h1-to-markdown` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-h1-to-markdown"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-h2-to-markdown` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-h2-to-markdown"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-h3-to-markdown` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-h3-to-markdown"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-headings-with-attributes` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-handle-headings-with-attributes"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-strong-to-bold` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-strong-to-bold"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-b-to-bold` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-b-to-bold"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-em-to-italic` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-em-to-italic"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-i-to-italic` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-i-to-italic"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-unordered-list-items` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-unordered-list-items"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-ordered-list-items` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-ordered-list-items"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-paragraphs` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-paragraphs"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-br-to-newline` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-br-to-newline"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-links-to-markdown-format` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-links-to-markdown-format"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-links-with-extra-attributes` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-handle-links-with-extra-attributes"}
```
...
> 📄 **Snippet:** `// start snippet should-decode-common-html-entities` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-decode-common-html-entities"}
```
...
> 📄 **Snippet:** `// start snippet should-convert-nbsp-to-space` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-convert-nbsp-to-space"}
```
...
> 📄 **Snippet:** `// start snippet should-strip-unknown-html-tags` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-strip-unknown-html-tags"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-empty-input` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-handle-empty-input"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-plain-text` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-handle-plain-text"}
```
...
> 📄 **Snippet:** `// start snippet should-collapse-multiple-newlines` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-collapse-multiple-newlines"}
```
...
> 📄 **Snippet:** `// start snippet should-trim-whitespace` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-trim-whitespace"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-nested-formatting` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-handle-nested-formatting"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-full-document-structure` in [`tests/gemini-client.unit.test.ts`](tests/gemini-client.unit.test.ts)

```{.typescript include="tests/gemini-client.unit.test.ts" snippet="should-handle-full-document-structure"}
```
...
### 📁 `gemini-windmill.test.ts` <small>(Integration/Orphan)</small>
...
> 📄 **Snippet:** `// start snippet queryviawindmill-should-delegate-to-windmillclient` in [`tests/gemini-windmill.test.ts`](tests/gemini-windmill.test.ts)

```{.typescript include="tests/gemini-windmill.test.ts" snippet="queryviawindmill-should-delegate-to-windmillclient"}
```
...
> 📄 **Snippet:** `// start snippet queryviawindmill-should-pass-session-id-and-model` in [`tests/gemini-windmill.test.ts`](tests/gemini-windmill.test.ts)

```{.typescript include="tests/gemini-windmill.test.ts" snippet="queryviawindmill-should-pass-session-id-and-model"}
```
...
> 📄 **Snippet:** `// start snippet queryviawindmill-should-throw-if-windmill-is-not-c` in [`tests/gemini-windmill.test.ts`](tests/gemini-windmill.test.ts)

```{.typescript include="tests/gemini-windmill.test.ts" snippet="queryviawindmill-should-throw-if-windmill-is-not-c"}
```
...
> 📄 **Snippet:** `// start snippet queryviawindmill-should-throw-if-job-fails-interna` in [`tests/gemini-windmill.test.ts`](tests/gemini-windmill.test.ts)

```{.typescript include="tests/gemini-windmill.test.ts" snippet="queryviawindmill-should-throw-if-job-fails-interna"}
```
...
### 📁 `retry.test.ts` <small>(Integration/Orphan)</small>
...
> 📄 **Snippet:** `// start snippet should-succeed-on-the-first-attempt` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-succeed-on-the-first-attempt"}
```
...
> 📄 **Snippet:** `// start snippet should-retry-on-transient-server-errors-and-eventu` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-retry-on-transient-server-errors-and-eventu"}
```
...
> 📄 **Snippet:** `// start snippet should-fail-after-max-retries-on-persistent-server` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-fail-after-max-retries-on-persistent-server"}
```
...
> 📄 **Snippet:** `// start snippet should-fail-immediately-on-non-retriable-client-er` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-fail-immediately-on-non-retriable-client-er"}
```
...
> 📄 **Snippet:** `// start snippet should-handle-request-timeouts-and-retry` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-handle-request-timeouts-and-retry"}
```
...
> 📄 **Snippet:** `// start snippet should-connect-successfully-on-the-first-attempt` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-connect-successfully-on-the-first-attempt"}
```
...
> 📄 **Snippet:** `// start snippet should-retry-connection-and-eventually-succeed` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-retry-connection-and-eventually-succeed"}
```
...
> 📄 **Snippet:** `// start snippet should-fail-to-connect-after-max-retries` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-fail-to-connect-after-max-retries"}
```
...
> 📄 **Snippet:** `// start snippet should-trip-circuit-breaker-after-enough-consecuti` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-trip-circuit-breaker-after-enough-consecuti"}
```
...
> 📄 **Snippet:** `// start snippet should-transition-from-open-to-half-open-and-then-` in [`tests/retry.test.ts`](tests/retry.test.ts)

```{.typescript include="tests/retry.test.ts" snippet="should-transition-from-open-to-half-open-and-then-"}
```
...
### 📁 `stream-thoughts.integration.test.ts` <small>(Integration/Orphan)</small>
...
> 📄 **Snippet:** `// start snippet should-stream-thoughts-from-a-reasoning-query` in [`tests/stream-thoughts.integration.test.ts`](tests/stream-thoughts.integration.test.ts)

```{.typescript include="tests/stream-thoughts.integration.test.ts" snippet="should-stream-thoughts-from-a-reasoning-query"}
```
...
### 📁 `validation.unit.test.ts` <small>(Integration/Orphan)</small>
...
> 📄 **Snippet:** `// start snippet should-reject-empty-messages-array` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-reject-empty-messages-array"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-system-only-messages` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-reject-system-only-messages"}
```
...
> 📄 **Snippet:** `// start snippet should-accept-messages-with-user` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-accept-messages-with-user"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-invalid-role` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-reject-invalid-role"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-missing-role` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-reject-missing-role"}
```
...
> 📄 **Snippet:** `// start snippet should-accept-valid-roles` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-accept-valid-roles"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-object-content` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-reject-object-content"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-number-content` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-reject-number-content"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-undefined-content` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-reject-undefined-content"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-empty-user-message` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-reject-empty-user-message"}
```
...
> 📄 **Snippet:** `// start snippet should-reject-whitespace-only-user-message` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-reject-whitespace-only-user-message"}
```
...
> 📄 **Snippet:** `// start snippet should-allow-empty-assistant-content` in [`tests/validation.unit.test.ts`](tests/validation.unit.test.ts)

```{.typescript include="tests/validation.unit.test.ts" snippet="should-allow-empty-assistant-content"}
```
