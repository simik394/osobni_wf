...
app.post('/gemini/chat', async (req, res) => {
    try {
        ...
        const response = await activeGeminiClient.sendMessage(message, { waitForResponse, model, files, sources });
...
app.post('/gemini/send-message', async (req, res) => {
    try {
        ...
        const response = await activeGeminiClient.sendMessage(message, { waitForResponse: true, model, sources }); // Default to blocking/waiting
        res.json({ success: true, data: { response, sessionId: activeGeminiClient.getCurrentSessionId() } });
